    ...
    <div className='flex flex-col p-3 justify-between h-screen'>
      <div className='flex flex-col gap-4 '>
        ...
        >
          ...
          <span className='font-bold hidden xl:inline'>Página Inicial</span>
        </Link>
        {session ? (
          <button
            className='bg-blue-500 text-white rounded-full  hover:bg-blue-600 transition-all duration-200 w-44 h-9 shadow-md hidden xl:inline font-semibold'
            onClick={() => signOut()}
          >
            Sair
          </button>
